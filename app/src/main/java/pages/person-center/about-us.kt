...
open class GenPagesPersonCenterAboutUs : BasePage {
    ...
    override fun `$render`(): Any? {
        ...
        return createVNode(_component_fui_button, utsMapOf("margin" to "24rpx 0", "type" to "link", "color" to "#465CFF", "text" to "用户协议/隐私政策"));
    }
    companion object {

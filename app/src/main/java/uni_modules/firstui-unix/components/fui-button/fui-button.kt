...
open class GenUniModulesFirstuiUnixComponentsFuiButtonFuiButton : VueComponent {
    ...
    override fun `$initMethods`() {
        this.handleStart = fun() {
            this.switchHover(true);
        }
        ;
        this.handleTap = fun(e: MouseEvent) {
            if (this.disabled) {
                return;
            }
            this.`$emit`("onclick", e);
        ...
        ;
        this.switchHover = fun(show: Boolean) {
        ...
        ;
        this.getParent = fun(name: String): Boolean {
            if (this.`$parent` == null) {
                return false;
            }
    ...
    open lateinit var handleStart: () -> Unit;
    open lateinit var handleTap: (e: MouseEvent) -> Unit;
    open lateinit var handleEnd: () -> Unit;
    open lateinit var switchHover: (show: Boolean) -> Unit;
    open lateinit var startSpin: () -> Unit;
    open lateinit var endSpin: () -> Unit;
    open lateinit var onEnd: () -> Unit;
    open lateinit var getParent: (name: String) -> Boolean;
    companion object {
        var name = "fui-button";
        ...
        val styles0: Map<String, Map<String, Map<String, Any>>>
            get() {
                return utsMapOf("fui-button__wrap" to padStyleMapOf(utsMapOf("position" to "relative", "display" to "flex", "flexDirection" to "row", "alignItems" to "center", "justifyContent" to "center", "boxSizing" to "border-box", "overflow" to "hidden")), "fui-button__flex-1" to padStyleMapOf(utsMapOf("width" to "100%")), "fui-button__opacity" to padStyleMapOf(utsMapOf("opacity" to 0.5)), "fui-button__hover" to padStyleMapOf(utsMapOf("position" to "absolute", "left" to 0, "right" to 0, "top" to 0, "bottom" to 0, "backgroundColor" to "rgba(0,0,0,0.2)", "zIndex" to 2, "borderRadius" to 0, "visibility" to "hidden", "pointerEvents" to "none")), "fui-button__spin" to padStyleMapOf(utsMapOf("width" to "32rpx", "height" to "32rpx", "borderWidth" to 2, "borderStyle" to "solid", "borderRadius" to 100, "transitionDuration" to "600ms", "transitionProperty" to "transform", "transitionTimingFunction" to "linear", "transform" to "rotate(0deg)", "boxSizing" to "border-box", "marginRight" to "8rpx", "position" to "relative")), "fui-button__text" to padStyleMapOf(utsMapOf("textAlign" to "center")), "fui-text__bold" to padStyleMapOf(utsMapOf("fontWeight" to "bold")), "fui-button__link" to padStyleMapOf(utsMapOf("!borderColor" to "rgba(0,0,0,0)", "!backgroundColor" to "rgba(0,0,0,0)")), "fui-button__primary" to padStyleMapOf(utsMapOf("!borderColor" to "#465CFF", "!backgroundImage" to "none", "!backgroundColor" to "#465CFF")), "fui-button__success" to padStyleMapOf(utsMapOf("!borderColor" to "#09BE4F", "!backgroundImage" to "none", "!backgroundColor" to "#09BE4F")), "fui-button__warning" to padStyleMapOf(utsMapOf("!borderColor" to "#FFB703", "!backgroundImage" to "none", "!backgroundColor" to "#FFB703")), "fui-button__danger" to padStyleMapOf(utsMapOf("!borderColor" to "#FF2B2B", "!backgroundImage" to "none", "!backgroundColor" to "#FF2B2B")), "fui-button__purple" to padStyleMapOf(utsMapOf("!borderColor" to "#6831FF", "!backgroundImage" to "none", "!backgroundColor" to "#6831FF")), "fui-button__gray" to padStyleMapOf(utsMapOf("!borderColor" to "#F8F8F8", "!backgroundImage" to "none", "!backgroundColor" to "#F8F8F8")), "fui-btn__gray-color" to padStyleMapOf(utsMapOf("!color" to "#465CFF")), "fui-button__height" to padStyleMapOf(utsMapOf("!height" to "96rpx")), "fui-button__height-text" to padStyleMapOf(utsMapOf("!height" to "96rpx", "!lineHeight" to "96rpx")), "fui-button__size" to padStyleMapOf(utsMapOf("!fontSize" to "32rpx")), "fui-button__radius" to padStyleMapOf(utsMapOf("!borderRadius" to "16rpx")), "@TRANSITION" to utsMapOf("fui-button__spin" to utsMapOf("duration" to "600ms", "property" to "transform", "timingFunction" to "linear")));
            }
